...
export default async function getTax(status, income, state) {
  ...
  if (taxB.rate == 10 && status == "S" || "MFS") {
    return  kk * (1 - stTaxLow - taxBRate);
    console.log(res);
  } else if (taxB.rate == 12 && status == "S" || "MFS") {
    const currentTax = (kk - taxBMin) * taxBRate;
    const stTax = kk * stTaxLow;
    return  kk - currentTax - stTax - SB10;
    console.log(res);
  } else if (taxB.rate == 22 && status == "S" || "MFS") {
    const currentTax = (kk - taxBMin) * taxBRate;
    const stTax = kk * stTaxLow;
    return  kk - currentTax - stTax - SB10 - SB12;
    console.log(res);
  }else if (taxB.rate == 24 && status == "S" || "MFS") {
    const currentTax = (kk - taxBMin) * taxBRate;
    const stTax = kk * stTaxLow;
    return  kk - currentTax - stTax - SB10 - SB12 - SB22;
    console.log(res);
}else if (taxB.rate == 32 && status == "S" || "MFS") {
    const currentTax = (kk - taxBMin) * taxBRate;
    const stTax = kk * stTaxHigh;
    return  kk - currentTax - stTax - SB10 - SB12 - SB22 - SB24;
    console.log(res);
}else if (taxB.rate == 35 && status == "S" || "MFS") {
    const currentTax = (kk - taxBMin) * taxBRate;
    const stTax = kk * stTaxHigh;
    return  kk - currentTax - stTax - SB10 - SB12 - SB22 - SB24 - SB32;
    console.log(res);
}else if (taxB.rate == 37 && status == "S" || "MFS") {
    const currentTax = (kk - taxBMin) * taxBRate;
    const stTax = kk * stTaxHigh;
    return  kk - currentTax - stTax - SB10 - SB12 - SB22 - SB24 - SB32 - SB35;
    console.log(res);
}
  ...
  return  kk * (1 - stTaxLow - taxBRate);
    ...
    const currentTax = (kk - taxBMin) * taxBRate;
    const stTax = kk * stTaxLow;
    return  kk - currentTax - stTax - MB10;
    console.log(res);
  } else if (taxB.rate == 22 && status == "QW" || "MFJ") {
    const currentTax = (kk - taxBMin) * taxBRate;
    const stTax = kk * stTaxLow;
    return  kk - currentTax - stTax - MB10 - MB12;
    console.log(res);
  }else if (taxB.rate == 24 && status == "QW" || "MFJ") {
    const currentTax = (kk - taxBMin) * taxBRate;
    const stTax = kk * stTaxLow;
    return  kk - currentTax - stTax - MB10 - MB12 - MB22;
    console.log(res);
}else if (taxB.rate == 32 && status == "QW" || "MFJ") {
    const currentTax = (kk - taxBMin) * taxBRate;
    const stTax = kk * stTaxHigh;
    return  kk - currentTax - stTax - MB10 - MB12 - MB22 - MB24;
    console.log(res);
}else if (taxB.rate == 35 && status == "QW" || "MFJ") {
    const currentTax = (kk - taxBMin) * taxBRate;
    const stTax = kk * stTaxHigh;
    return  kk - currentTax - stTax - MB10 - MB12 - MB22 - MB24 - MB32;
    console.log(res);
}else if  (taxB.rate == 37 && status == "QW" || "MFJ") {
    const currentTax = (kk - taxBMin) * taxBRate;
    const stTax = kk * stTaxHigh;
    return  kk - currentTax - stTax - MB10 - MB12 - MB22 - MB24 - MB32 - MB35;
    console.log(res);
}else {
return ""
